...
public class FirstPersonController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {   
            ...
            PlayerInventory playerInv = GameManager.instance.getPlayerInventory();
            if (playerInv.inventory != null)
                inventory = playerInv.inventory;
			if (playerInv.storage != null)
                storage = playerInv.storage;
    ...
    bool lockMovement()
    {
        ...
        if (inventory != null && inventory.activeSelf)
            ...
            return true;
        else if (storage != null && storage.activeSelf)
            return true;
        else
            return false;
